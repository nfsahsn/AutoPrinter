...
class Config:
    ...
    PUBLIC_BASE_URL = os.environ.get("PUBLIC_BASE_URL", "https://autoprinter-ieo2.onrender.com")
    ...
    XPAY_BASE_URL = os.environ.get("XPAY_BASE_URL", "https://xpay-4yni.onrender.com").rstrip("/")
